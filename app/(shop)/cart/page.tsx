                        ...
                        >
                            ...
                            <div className="flex-1 flex flex-col justify-between">
                                <div>
                                    ...
                                    <p className="text-slate-500 text-sm">Size: <span className="font-medium text-slate-700">{item.size}</span></p>
                                </div>
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm sticky top-24">
                        ...
                        <button
                            ...
                            className="w-full bg-slate-900 text-white py-4 rounded-xl font-bold text-lg hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/10 active:scale-95 flex items-center justify-center gap-2 group"
                        >
                            Checkout
