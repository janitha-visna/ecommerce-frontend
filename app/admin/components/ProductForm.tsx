...
export default function ProductForm() {
  ...
  if (!isAdmin)
    return <p className="text-center mt-20 text-red-500">Access denied</p>;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        toast.success(`Product added successfully! ID: ${result.productId}`);
  ...
  return (
    <form
      ...
      className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500"
    >
